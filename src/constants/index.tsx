...
"Utilizing point cloud data (RCP/RCS) to ensure high-accuracy representation of existing site conditions.",
    ...
    tags: [
      ...
      },
      {
        id: 4,
        name: "RCP",
        path: "/assets/logos/rcp.svg",
      },
    ],
  },
  {
    id: 2,
    title: "UTSW Radiation, Oncology Center",
    description:
      "I did, set and configured revit parametric lighting families.",
    subDescription: [
      "Designed Revit Lighting families with face based templates for the project with parametric measures.",
      "Set the Revit Lighting families in ceilings and linked levels for Floor 1 and Floor 2.",
      "I did a QA/QC to check all the lights on floor 1 and 2.",
      "Collaborated with partners and watched out avoiding clashes.",
    ],
    href: "",
    logo: "",
    ...
    tags: [
      ...
      {
        id: 3,
        name: "Autodesk Construction Connector",
